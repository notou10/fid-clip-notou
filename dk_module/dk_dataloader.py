...
def get_dataloader(zip_path: str,
    ...
    total_imgs = len(glob(f"{num_images}/**/*.jpg", recursive=True)) + \
        len(glob(f"{num_images}/**/*.png", recursive=True)) + \
        len(glob(f"{num_images}/**/*.JPEG", recursive=True))

    
    item_subset = [i % total_imgs for i in range(total_imgs)]
